    ...
    public Menu() {
        ...
        while(continuarTrabajando) {
            ...
            if(continuarTrabajando){
                ...
                if(menuOpciones(continuar,opcionesContinuar, 0,1)==0) continuarTrabajando=false;
            }
        }
    ...
    private void menuClientes(){
        ...
        switch (menuOpciones(mensajeGenericoEntradaOpciones, opciones, minimo, maximo) ){
            ...
            case 2: //Dar de baja un cliente
                ...
                //TODO: mirar si lo borramos también del resto de estructuras de datos (Facturas y Llamadas).
        ...
        switch (menuOpciones(mensajeGenericoEntradaOpciones, opciones, minimo, maximo)) {
            case 1: //Dar de alta una llamada
                ...
                if(nif!=null) {
                    ...
                    Scanner sc= new Scanner(System.in);
                    System.out.print(peticionTelefono);
    ...
    */
    ...
    private Date peticionFechaYHora(boolean horaNecesaria){
        ...
        if(horaNecesaria){
            ...
            System.out.print(peticionSegundo);
