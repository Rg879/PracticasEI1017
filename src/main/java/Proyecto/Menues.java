...
public class Menues{
    ...
    private int entradaEnteroCorrecta(String mensajePeticion, int min, long max) {
        ...
        while (true) {
            ...
            if (min > dato || dato > max) {
                System.out.format(mensajeDatoIncorrecto+"valor mínimo= %d, valor máximo: %d \n", min, max);
            }else break;
        }
        return dato;
    }
    ...
    public void menuPrincipal () {
        ...
        while(continuarTrabajando) {
            ...
            if(continuarTrabajando){
                ...
                int s=1, n=0;
                if(menuOpciones(continuar,opcionesContinuar,s,n)==0) continuarTrabajando=false;
            }
        }
        ...
        while(continuarEnElMenu) {
            ...
            switch (menuOpciones(mensajeGenericoEntradaOpciones, opciones, minimo, maximo)) {
                ...
                case 2: //Recuperar los datos de la factura a partir del código de factura
                    ...
                    sc.close();
                    Factura facturaRecuperada=this.conjuntoDatosFacturas.recuperarDatos(codigo);
    ...
    /*TODO [En desarrollo]: Hacer que la clase tenga una devolución genérica
